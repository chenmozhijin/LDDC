...
from LDDC.backend.decryptor.qmc1 import qmc1_decrypt
from LDDC.backend.decryptor.tripledes import DECRYPT, tripledes_crypt, tripledes_key_setup
from LDDC.utils.enum import QrcType
from LDDC.utils.error import LyricsDecryptError
