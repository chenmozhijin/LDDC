...
class Ui_about:
    def setupUi(self, about):
        ...
        sizePolicy.setHeightForWidth(
            self.github_pushButton.sizePolicy().hasHeightForWidth(),
        )
        ...
        sizePolicy.setHeightForWidth(
            self.checkupdate_pushButton.sizePolicy().hasHeightForWidth(),
        )
        ...
        sizePolicy.setHeightForWidth(
            self.githubissues_pushButton.sizePolicy().hasHeightForWidth(),
        )
    ...
    def retranslateUi(self, about):
        ...
        self.title_label.setText(
            QCoreApplication.translate("about", "\u5173\u4e8e", None),
        )
        self.label.setText(
        ...
        self.version_label.setText(
            QCoreApplication.translate("about", "\u7248\u672c | ", None),
        )
        self.github_pushButton.setText(
            QCoreApplication.translate("about", "GitHub\u4ed3\u5e93", None),
        )
        self.checkupdate_pushButton.setText(
            QCoreApplication.translate("about", "\u68c0\u67e5\u66f4\u65b0", None),
        )
        self.githubissues_pushButton.setText(
            QCoreApplication.translate("about", "\u95ee\u9898\u53cd\u9988", None),
        )
