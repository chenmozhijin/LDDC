...
class Ui_search_base(object):
    def setupUi(self, search_base):
        ...
        self.control_verticalLayout.setObjectName(u"control_verticalLayout")
    ...
    def retranslateUi(self, search_base):
        search_base.setWindowTitle(QCoreApplication.translate("search_base", u"Form", None))
        self.source_comboBox.setItemText(0, QCoreApplication.translate("search_base", u"QQ\u97f3\u4e50", None))
        self.source_comboBox.setItemText(1, QCoreApplication.translate("search_base", u"\u9177\u72d7\u97f3\u4e50", None))
        self.source_comboBox.setItemText(2, QCoreApplication.translate("search_base", u"\u7f51\u6613\u4e91\u97f3\u4e50", None))

        self.search_type_comboBox.setItemText(0, QCoreApplication.translate("search_base", u"\u5355\u66f2", None))
        self.search_type_comboBox.setItemText(1, QCoreApplication.translate("search_base", u"\u4e13\u8f91", None))
        self.search_type_comboBox.setItemText(2, QCoreApplication.translate("search_base", u"\u6b4c\u5355", None))

        self.search_pushButton.setText(QCoreApplication.translate("search_base", u"\u641c\u7d22", None))
        self.result_label.setText(QCoreApplication.translate("search_base", u"\u641c\u7d22\u7ed3\u679c", None))
        self.return_toolButton.setText(QCoreApplication.translate("search_base", u"\u8fd4\u56de", None))
        self.label_8.setText(QCoreApplication.translate("search_base", u"\u6b4c\u8bcd\u9884\u89c8", None))
        self.label_2.setText(QCoreApplication.translate("search_base", u"\u6b4c\u8bcd\u7c7b\u578b", None))
        self.lyric_types_lineEdit.setText("")
        self.label_3.setText(QCoreApplication.translate("search_base", u"\u6b4c\u66f2/\u6b4c\u8bcdid", None))
        self.original_checkBox.setText(QCoreApplication.translate("search_base", u"\u539f\u6587", None))
        self.translate_checkBox.setText(QCoreApplication.translate("search_base", u"\u8bd1\u6587", None))
        self.romanized_checkBox.setText(QCoreApplication.translate("search_base", u"\u7f57\u9a6c\u97f3", None))
        self.label_5.setText(QCoreApplication.translate("search_base", u"\u504f\u79fb\u91cf:", None))
        self.label_9.setText(QCoreApplication.translate("search_base", u"\u6b4c\u8bcd\u683c\u5f0f:", None))
        self.lyricsformat_comboBox.setItemText(0, QCoreApplication.translate("search_base", u"LRC(\u9010\u5b57)", None))
        self.lyricsformat_comboBox.setItemText(1, QCoreApplication.translate("search_base", u"LRC(\u9010\u884c)", None))
        self.lyricsformat_comboBox.setItemText(2, QCoreApplication.translate("search_base", u"\u589e\u5f3a\u578bLRC(ESLyric)", None))
        self.lyricsformat_comboBox.setItemText(3, QCoreApplication.translate("search_base", u"SRT", None))
        self.lyricsformat_comboBox.setItemText(4, QCoreApplication.translate("search_base", u"ASS", None))
