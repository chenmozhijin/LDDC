...
class Ui_search_base:
    def setupUi(self, search_base):
        ...
        sizePolicy.setHeightForWidth(
            self.search_keyword_lineEdit.sizePolicy().hasHeightForWidth(),
        )
        ...
        self.return_toolButton.setToolButtonStyle(
        ...
        self.results_tableWidget = ProportionallyStretchedTableWidget(
            self.layoutWidget_2,
        )
        self.results_tableWidget.setObjectName("results_tableWidget")
        sizePolicy1.setHeightForWidth(
            self.results_tableWidget.sizePolicy().hasHeightForWidth(),
        )
        self.results_tableWidget.setSizePolicy(sizePolicy1)
        self.results_tableWidget.setHorizontalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded,
        )
        self.results_tableWidget.setSizeAdjustPolicy(
            QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored,
        )
        self.results_tableWidget.setEditTriggers(
            QAbstractItemView.EditTrigger.NoEditTriggers,
        )
        self.results_tableWidget.setProperty("showDropIndicator", False)
        self.results_tableWidget.setSelectionMode(
            QAbstractItemView.SelectionMode.SingleSelection,
        )
        self.results_tableWidget.setSelectionBehavior(
        ...
        self.results_tableWidget.horizontalHeader().setProperty(
        ...
        self.lyric_types_lineEdit.setObjectName("lyric_types_lineEdit")
        ...
        sizePolicy.setHeightForWidth(
            self.songid_lineEdit.sizePolicy().hasHeightForWidth(),
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.preview_plainTextEdit.sizePolicy().hasHeightForWidth(),
        )
        ...
        sizePolicy.setHeightForWidth(
            self.original_checkBox.sizePolicy().hasHeightForWidth(),
        )
        ...
        self.control_verticalSpacer = QSpacerItem(
        ...
        self.horizontalSpacer_3 = QSpacerItem(
            97, 20, QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Minimum,
        )
    ...
    def retranslateUi(self, search_base):
        search_base.setWindowTitle(
            QCoreApplication.translate("search_base", "Form", None),
        )
        self.source_comboBox.setItemText(
            0, QCoreApplication.translate("search_base", "QQ\u97f3\u4e50", None),
        )
        self.source_comboBox.setItemText(
            1,
            QCoreApplication.translate("search_base", "\u9177\u72d7\u97f3\u4e50", None),
        )
        self.source_comboBox.setItemText(
            2,
            QCoreApplication.translate(
                "search_base", "\u7f51\u6613\u4e91\u97f3\u4e50", None,
            ),
        )

        self.search_type_comboBox.setItemText(
            0, QCoreApplication.translate("search_base", "\u5355\u66f2", None),
        )
        self.search_type_comboBox.setItemText(
            1, QCoreApplication.translate("search_base", "\u4e13\u8f91", None),
        )
        self.search_type_comboBox.setItemText(
            2, QCoreApplication.translate("search_base", "\u6b4c\u5355", None),
        )

        self.search_keyword_lineEdit.setInputMask("")
        self.search_keyword_lineEdit.setText("")
        self.search_keyword_lineEdit.setPlaceholderText(
            QCoreApplication.translate(
                "search_base", "\u8f93\u5165\u5173\u952e\u8bcd", None,
            ),
        )
        self.search_pushButton.setText(
            QCoreApplication.translate("search_base", "\u641c\u7d22", None),
        )
        self.result_label.setText(
            QCoreApplication.translate("search_base", "\u641c\u7d22\u7ed3\u679c", None),
        )
        self.return_toolButton.setText(
            QCoreApplication.translate("search_base", "\u8fd4\u56de", None),
        )
        self.label_8.setText(
            QCoreApplication.translate("search_base", "\u6b4c\u8bcd\u9884\u89c8", None),
        )
        self.label_2.setText(
            QCoreApplication.translate("search_base", "\u6b4c\u8bcd\u7c7b\u578b", None),
        )
        self.lyric_types_lineEdit.setText("")
        self.label_3.setText(
            QCoreApplication.translate(
                "search_base", "\u6b4c\u66f2/\u6b4c\u8bcdid", None,
            ),
        )
        self.original_checkBox.setText(
            QCoreApplication.translate("search_base", "\u539f\u6587", None),
        )
        self.translate_checkBox.setText(
            QCoreApplication.translate("search_base", "\u8bd1\u6587", None),
        )
        self.romanized_checkBox.setText(
            QCoreApplication.translate("search_base", "\u7f57\u9a6c\u97f3", None),
        )
        self.label_5.setText(
            QCoreApplication.translate("search_base", "\u504f\u79fb\u91cf:", None),
        )
        self.label_9.setText(
            QCoreApplication.translate("search_base", "\u6b4c\u8bcd\u683c\u5f0f:", None),
        )
        self.lyricsformat_comboBox.setItemText(
            0, QCoreApplication.translate("search_base", "LRC(\u9010\u5b57)", None),
        )
        self.lyricsformat_comboBox.setItemText(
            1, QCoreApplication.translate("search_base", "LRC(\u9010\u884c)", None),
        )
        self.lyricsformat_comboBox.setItemText(
            2,
            QCoreApplication.translate(
                "search_base", "\u589e\u5f3a\u578bLRC(ESLyric)", None,
            ),
        )
        self.lyricsformat_comboBox.setItemText(
            3, QCoreApplication.translate("search_base", "SRT", None),
        )
        self.lyricsformat_comboBox.setItemText(
            4, QCoreApplication.translate("search_base", "ASS", None),
        )
